        ...
        <div className="relative w-full bg-white">
          <div className="mx-auto">
            <div className="flex flex-col justify-center px-4 py-12 md:py-12 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-12 xl:col-span-6">
              <div className="mt-8 flex max-w-max items-center space-x-2 rounded-full bg-white p-1">
                <div className="rounded-full border p-2 px-4">
                  <p className="text-xs font-medium md:text-sm">
                    Lorem ipsum dolor sit amet consectetur.
                    <span className="ml-2 cursor-pointer font-bold text-blue-700">
                      Read More →
                    </span>
                  </p>
                </div>
              ...
              <p className="mt-8 text-lg text-gray-700">
                ...
                esse qui repudiandae cum fuga aspernatur ea? Lorem ipsum dolor
                sit amet consectetur adipisicing elit. Officia ipsam nulla
                aperiam quo possimus, nihil molestiae modi tenetur esse qui
                repudiandae cum fuga aspernatur ea?
              </p>
              <div className="mt-8">
                <button
                  type="button"
                  className="inline-flex bg-primary-web mx-2 py-2  px-5  text-white font-semibold rounded-full shadow-md hover:bg-blue-primary focus:outline-none focus:ring focus:ring-violet-400 focus:ring-opacity-75"
                >
                  Get started Today
                </button>
                <a
